 ...
 *
 */
@SpringBootApplication(scanBasePackages = {"com.lina.market_project.config"})
public class LocalUtil {


    //各地区xml文件路径
    private static final String LOCAL_LIST_PATH = "C:\\Users\\29239\\IdeaProjects\\market_project\\LocList.xml";
    //所有国家名称List
